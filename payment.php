...
<head>
  ...
  <link rel="stylesheet" href="style_payment.css?v=0.1">
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none">
  ...
  <symbol id="icon-cash" viewBox="0 0 24 24">
    ...
    <path d="M21 3H3c-1.1 0-1.99.9-1.99 2L1 19c0 1.1.89 2 1.99 2H21c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 14H4c-.55 0-1-.45-1-1s.45-1 1-1h16c.55 0 1 .45 1 1s-.45 1-1 1zm0-4H4c-.55 0-1-.45-1-1s.45-1 1-1h16c.55 0 1 .45 1 1s-.45 1-1 1zm0-4H4c-.55 0-1-.45-1-1s.45-1 1-1h16c.55 0 1 .45 1 1s-.45 1-1 1z"/>
</symbol>
